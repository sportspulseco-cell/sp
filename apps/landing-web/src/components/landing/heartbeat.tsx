...
/**
 * Sticky 1px cyan heartbeat pinned to the bottom of the viewport. Frequency
 * and amplitude react to scroll velocity — idle = slow gentle pulse, fast
 * scroll = tighter, taller wave. The bar itself is fixed; the inner waveform
 * is an SVG path animated via stroke-dashoffset.
 */
